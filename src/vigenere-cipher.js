...
class VigenereCipheringMachine {
  ...
  createSquare(str, key) {
    ...
    this.alphabet.forEach((_, i) => this.square[i] = this.alphabet.slice(i).concat(this.alphabet.slice(0, i)))
  }
  ...
  encrypt(str, key) {
    ...
    cryptKey.forEach((el, index) => {
      ...
      resultStr.push( (!this.strUp[index].match(/[A-Z]/)) ? el : this.square[firstIndex][secondIndex] )
    });
  ...
  decrypt(str, key) {
    ...
    cryptKey.forEach((el, index) => {
      ...
      resultStr.push( (!this.strUp[index].match(/[A-Z]/)) ? el : this.square[0][secondIndex] )
    });
